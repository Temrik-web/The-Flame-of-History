...
public class Flashlight : MonoBehaviour
{
    ...
    /// (а не компонентом камеры), чтобы его можно было позиционировать,
    /// отдельно анимировать и навесить свои меши и звук.
    /// </summary>
    ...
    /// затуханием к краю и лёгкой неравномерностью отражателя.
